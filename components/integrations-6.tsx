        ...
        <section>
            <div className="bg-muted dark:bg-background py-24 md:py-32">
                <div className="mx-auto max-w-5xl px-6">
                    <div className="relative overflow-hidden mx-auto max-w-md [mask-image:radial-gradient(ellipse_100%_100%_at_50%_0%,#000_70%,transparent_100%)]">
                    ...
                    <div className="mx-auto mt-6 max-w-lg space-y-6 text-center">
                        <h2 className="text-balance text-3xl font-semibold md:text-4xl lg:text-5xl">Connect your project ecosystem</h2>
                        <p className="text-muted-foreground">Link GitHub, Jira, and other platforms seamlessly. We capture your team's real-world performance data.</p>
